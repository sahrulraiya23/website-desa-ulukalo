    ...
    <section id="visi-misi" class="section">
        <div class="container">
            ...
            <div class="row g-4 align-items-stretch mb-5">
                <div class="col-lg-5">
                    <div class="h-100 p-4 p-lg-5 border rounded-4 bg-white bg-gradient text-white">
                        ...
                        <div class="row row-cols-1 g-3">
                            <div class="col">
                                <div class="d-flex align-items-start">
                                    ...
                                    <p class="mb-0 small">
                                        <strong>Optimalisasi Kinerja Perangkat:</strong> Mengoptimalkan kinerja perangkat
                                        desa
                            ...
                            <div class="col">
                                <div class="d-flex align-items-start">
                                    ...
                                    <p class="mb-0 small">
                                        <strong>Responsivitas Pemerintahan:</strong> Menciptakan pemerintah desa yang cepat
                                        tanggap
                                        terhadap keadaan dan aspirasi masyarakat dengan terjun langsung melihat kondisi
                                        masyarakat
                            ...
                            <div class="col">
                                <div class="d-flex align-items-start">
                                    ...
                                    <p class="mb-0 small">
                                        <strong>Koordinasi Kelembagaan:</strong> Koordinasi dan bekerja sama dengan semua
                                        unsur
                                        kelembagaan desa, lembaga keagamaan dan lembaga sosial politik untuk memberikan
                                        pelayanan
                                        terbaik dalam bidang keagamaan, pendidikan, ekonomi, sosial, politik, budaya,
                                        olahraga,
                ...
                <div class="row g-4">
                    <div class="col-lg-6">
                        <div class="p-4 border rounded-4 h-100 bg-light">
                            ...
                            <ul class="mb-0">
                                <li class="mb-2">Meningkatnya kualitas hidup dan kesejahteraan warga melalui optimalisasi
                                    potensi lokal</li>
                                <li class="mb-2">Terwujudnya tata kelola pemerintahan desa yang akuntabel dan responsif
                                </li>
                                <li class="mb-2">Penguatan ekonomi keluarga berbasis pertanian dan peternakan
                                    berkelanjutan</li>
                                <li class="mb-2">Peningkatan akses dan kualitas layanan dasar (kesehatan, pendidikan,
                                    infrastruktur)</li>
                                <li class="mb-0">Terciptanya harmoni sosial dan partisipasi aktif masyarakat dalam
                                    pembangunan</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="p-4 border rounded-4 h-100">
                            ...
                            <ul class="mb-0">
                                ...
                                <li class="mb-2">Peningkatan produktivitas sektor pertanian dan peternakan sebesar 15%
                                    per tahun</li>
                                <li class="mb-2">Tercapainya akses air bersih, infrastruktur jalan, dan konektivitas
                                    internet di semua dusun</li>
                                <li class="mb-2">Menurunnya angka kemiskinan dan meningkatnya partisipasi masyarakat
                                    dalam UMKM</li>
                                <li class="mb-0">Terlaksananya program kesehatan preventif dengan cakupan 100% keluarga
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="text-center p-4 bg-primary bg-gradient rounded-4 text-white mb-5">
                ...
                <p class="mb-0">
                    ...
                    yang maju, mandiri, sehat, dan sejahtera bagi seluruh masyarakat dari berbagai latar belakang suku dan
                    budaya."
                </p>
                <div class="mt-3">
