        ...
        <div class="container">
            ...
            <div class="filter-wrap row g-3 align-items-center mb-4">
                ...
                <div class="col-md-3 text-md-end">
                    <a href="{{ route('struktur') }}" class="btn btn-outline-dark"><i class="bi bi-diagram-3 me-1"></i>
                        Lihat Struktur Desa</a>
                </div>
            </div>
            ...
            <div id="aparatGrid" class="row g-4">
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card aparat-card h-100 border-0 shadow-sm">
                        <img src="{{ asset('assets/img/aparat/placeholder.jpg') }}" class="card-img-top"
                            alt="Foto Kepala Desa">
                        <div class="card-body">
                            <h5 class="card-title mb-1">Budi Santoso</h5>
                            <div class="jabatan">Kepala Desa</div>
                            <div class="dusun">Dusun I</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card aparat-card h-100 border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            <h5 class="card-title mb-1">Siti Aminah</h5>
                            <div class="jabatan">Sekretaris Desa</div>
                            <div class="dusun">Dusun II</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-lg-4">
                    <div class="card aparat-card h-100 border-0 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="jabatan">Kepala Dusun</div>
                            <div class="dusun">Dusun III</div>
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    <script>
        ...
        function uniqueDusun(list) {
            const set = new Set();
            list.forEach(x => {
                if (x.dusun && x.dusun.trim() !== '') set.add(x.dusun);
            });
        ...
        fetch(`{{ asset('assets/js/aparat.json') }}`)
            ...
            .then(json => {
                ...
                DUSUN.innerHTML = '<option value="">Semua Dusun</option>' + dusunList.map(d =>
